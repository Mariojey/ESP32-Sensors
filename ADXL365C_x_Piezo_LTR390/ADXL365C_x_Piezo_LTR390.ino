...
void setup() {
  ...
  appendFile(SD, "/adxl356c_und_piezo__und_ltr390_19_04_22_30.txt","ACC xy, ACC z, Vib,   UV\n");
...
void loop() {
  ...
  sprintf(buffer, "%d    %d    %d   %d\n", val_xy, val_z, vib, data_uv);
  appendFile(SD, "/adxl356c_und_piezo__und_ltr390_19_04_22_30.txt", buffer);
